...
while(have_posts()) {
    ...
    <div class="container container--narrow page-section">
        <div class="create-note">
            ...
            <span style="margin-top: 20px" class="submit-note">Create Note</span>
            <span class="note-limit-message">5 notes allowed. Delete an existing note to make room for a new one.</span>
        </div>

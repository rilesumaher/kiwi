  ...
  <div class="container container--narrow page-section">
    ...
    <div class="generic-content"><?php the_field('main_body_content'); ?></div>
      ...
      if ($relatedProfessors->have_posts()) {
        ...
        echo '<h2>' . get_the_title() . ' Professor(s)</h2>';
      ...
      //  Related events
      $today = date('Ymd');
      $onProgramEvents = new WP_Query(array(
        'posts_per_page' => 2,
        'post_type' => 'event',
        'meta_key' => 'event_date',
      ...
      if ($onProgramEvents->have_posts()) {
        echo '<hr class="section-break">';
        echo '<h2>Upcoming ' . get_the_title() . ' Events</h2>';

        while ($onProgramEvents->have_posts()) {
          $onProgramEvents->the_post();
      ...
      if ($relatedCampuses) {
        echo '<hr class="section-break">';
        echo '<h2>' . get_the_title() . ' is available on these Campuses:</h2>';

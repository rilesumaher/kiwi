...
const Like = new _modules_Likes__WEBPACK_IMPORTED_MODULE_5__["default"]();
...
class Like {
  ...
  createLike(currentLikeBox) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
      ...
      url: universityData.root_url + '/wp-json/kiwi/v1/like',
      type: 'POST',
      data: {
    ...
    try {
      ...
      if (response.data != "You have reached your note limit.") {
        ...
        document.querySelector("#my-notes").insertAdjacentHTML("afterbegin", ` <li data-id="${response.data.id}" class="fade-in-calc">
            <input readonly class="note-title-field" value="${response.data.title.rendered}">
            <span class="edit-note"><i class="fa fa-pencil" aria-hidden="true"></i> Edit</span>
            <span class="delete-note"><i class="fa fa-trash-o" aria-hidden="true"></i> Delete</span>
            <textarea readonly class="note-body-field">${response.data.content.rendered}</textarea>
...
class Search {
  ...
  constructor() {
    // In this case ordering does matter
    this.addSearchHTML();
  ...
  getResults() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default().getJSON(universityData.root_url + "/wp-json/kiwi/v1/search?term=" + this.searchField.val(), results => {
      this.resultsDiv.html(`
        <div class="row">
          <div class="one-third">
  ...
  openOverlay() {
    ...
    // This will prevent a default behavior of a link elements
    return false;
  }
  closeOverlay() {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkkiwi_theme"] = self["webpackChunkkiwi_theme"] || [];
